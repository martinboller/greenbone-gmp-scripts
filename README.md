...
### Useful Python scripts that can be used to configure your Greenbone Source Edition Scanner ###
I hope these will make your life a little easier managing Greenbone.  <br/><br/> 
...
- Usage: gvm-script --gmp-username admin --gmp-password '0f6fa69b-32bb-453a-9aa4-b8c9e56b3d00' socket export-csv-report.gmp.py *report_uuid* ./output.csv<br/><br/> 
...
### list-reports.gmp.py ###
**Lists all reports that have finished (status=done)**
