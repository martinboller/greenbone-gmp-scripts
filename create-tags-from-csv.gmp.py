...
def config_id(
    ...
    for scan_config in scan_configs_xml:
        "".join(scan_config.xpath("name/text()"))
...
def credential_id(
    ...
    for credential in credentials_xml:
        "".join(credential.xpath("name/text()"))
